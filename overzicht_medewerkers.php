    ...
    <h2>Medewerker account's</h2>
        <table class="table " id="overview">
            ...
            while($row = $result->fetch(PDO::FETCH_ASSOC)) {         
                ...
                echo "<td><a href=\"update.php?id=$row[id]\">Edit</a> | <a href=\"delete.php?id=$row[id]\" onClick=\"return confirm('Weet je zeker dat je wilt verwijderen?')\">Delete</a></td>";        
            }
            ?>
			</tbody>
		</table>
...
<h4>
<p>nieuwe medewerker account aanmaken<a href="create.php" style="color:#FF0000;"><b>Click hier</b></a></p>
