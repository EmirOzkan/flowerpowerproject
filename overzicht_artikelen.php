    ...
    <h2>Overzicht artikelen</h2>
        <table class="table " id="overview">
            ...
            while($row = $result->fetch(PDO::FETCH_ASSOC)) {         
                ...
                echo "<td><a href=\"update_artikelen.php?id=$row[id]\"class='btn btn-warning'>Edit</a> | <a href=\"delete_artikel.php?id=$row[id]\" onClick=\"return confirm('Weet je zeker dat je wilt verwijderen?')\"class='btn btn-danger'>Delete</a></td>";    
            }
            ?>
			</tbody>
		</table>
...
<h4>
<p>nieuwe artikel aanmaken<a href="create_artikel.php" style="color:#FF0000;"><b>Click hier</b></a></p>
