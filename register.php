...
{	
	//Input names in array stoppen
	$fieldnames = array('username', 'email', 'password');

	$error = false;

	//Loop door de array en stop de variabele in $_POST, wnr variabele leeg is word $error gezet naar true
	...
	//Als $error false is word de functie opgeroepen
	if (!$error) {
		$register = new config();
			...
			<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
				<div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
					<div class="md:flex w-full">
						<div class="hidden md:block w-1/2 bg-purple-500 py-10 px-10">
						...
						<div class="w-full md:w-1/2 py-10 px-5 md:px-10">
							<div class="text-center mb-10">
								...
								<p>Hi, welcome to Emir Özkan's register</p>
							</div>
							<div>
								...
								<div class="flex -mx-3">
									<div class="w-full px-3 mb-12">
										...
										<div class="flex">
											...
											<input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-purple-500" name="username">
										</div>
									</div>
								</div>
								<div class="flex -mx-3">
									<div class="w-full px-3 mb-12">
										...
										<div class="flex">
											...
											<input type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-purple-500" name="email">
										</div>
									</div>
								</div>
								<div class="flex -mx-3">
									<div class="w-full px-3 mb-12">
										...
										<div class="flex">
											<div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
											<input type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-purple-500" name="password">
										</div>
									</div>
								</div>
								<div class="flex -mx-3">
									<div class="w-full px-3 mb-5">
										<button type="submit" name="register" class="block w-full max-w-xs mx-auto bg-purple-500 hover:bg-purple-700 focus:bg-purple-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
										<br>
										<p>Already a account?<a href="login.php"><b>Login here</b></a></p>
										<br>
										<p>Back to the main menu?<a href="index.php"><b>Click here</b></a></p>
									</div>
								</div>
								</form>
							</div>
